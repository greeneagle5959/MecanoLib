...
final class VilleController extends AbstractController
{
    ...
    #[Route('/api/v1/get_garages_by_ville/{codePostal}', name: 'api_get_garages_by_ville', methods: ['GET'])]
    public function getGaragesByCodePostal(string $codePostal, VilleRepository $villeRepository): JsonResponse
    {
        // Cherche la ville par son code postal
        $ville = $villeRepository->findOneBy(['codePostal' => $codePostal]);
