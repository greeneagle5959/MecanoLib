 ...
 */
final class Version20260420083110 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE
              associer
            ADD
              CONSTRAINT FK_FA230DB9B911D4E6 FOREIGN KEY (id_garage) REFERENCES garage (id_garage)
        SQL);
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE
              garage
            CHANGE
              nom_garage nom_garage VARCHAR(50) NOT NULL,
            CHANGE
              id_utilisateur id_utilisateur INT DEFAULT NULL
        SQL);
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE
              garage
            CHANGE
              nom_garage nom_garage VARCHAR(20) NOT NULL,
            CHANGE
              id_utilisateur id_utilisateur INT NOT NULL
        SQL);
