 ...
 */
final class Version20260304123041 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE marque (id_marque INT AUTO_INCREMENT NOT NULL, nom_marque VARCHAR(50) NOT NULL, id_modele INT NOT NULL, INDEX IDX_5A6F91CE363530B5 (id_modele), PRIMARY KEY (id_marque)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE modele (id_modele INT AUTO_INCREMENT NOT NULL, nom_modele VARCHAR(50) NOT NULL, PRIMARY KEY (id_modele)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE prestation (id_prestation INT AUTO_INCREMENT NOT NULL, nom_prestation VARCHAR(30) NOT NULL, description_prestation LONGTEXT NOT NULL, duree_prestation VARCHAR(10) NOT NULL, categorie_prestation VARCHAR(30) NOT NULL, prerequis LONGTEXT NOT NULL, ressource_requise LONGTEXT NOT NULL, id_garage INT NOT NULL, id_categorie INT NOT NULL, INDEX IDX_51C88FADB911D4E6 (id_garage), INDEX IDX_51C88FADC9486A13 (id_categorie), PRIMARY KEY (id_prestation)) DEFAULT CHARACTER SET utf8mb4');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prestation DROP FOREIGN KEY FK_51C88FADB911D4E6');
